...
var scenario = {
  ...
  two: {
    ...
    text: "När du står i kön så tar du på dig din rånar luva som du haft i fickan och sätter på dig den. Du är redo för att göra vad som krävs. Vad gör du?",
  ...
  eight: {
    ...
    text: "Du väntar snällt i kön tills det blir din tur. När du är framme vid kassan och ska betälla. Vad säger du till kasörskan?",
    buttons: [[" Vändligt", "advanceTo(scenario.six)"],["hotfullt", "advanceTo(scenario.seven)"]]
  },
  nine: {
  ...
  thirteen: {
    ...
    text: "Polisen är här och du medger ditt nederlag. Polisen batistabombar dig från köksbänken och sen tar de med dig till finkan",
    
  },
  fourteen: {
    image: "https://www.cisatracurium.de/images/cisatracuriumde/477-nike-air-max-97-lux-blacklaser-fuchsia-6505.jpg",
    text: "Eftersom att du är en sån alfa hane så vet du att det ända logiska sättet att komma där ifrån med livet i behåll är att ta på sig ainastudsare. Dessa fatastiska Air max är passs snabba att du lyckas göra klart din börgare och smita på samma gång. Polisen är kvar på donken helt förvirrade medans du är på joggingrunda hem med din börgare i handen",
  },
